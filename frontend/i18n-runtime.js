(function () {
  ...
  "vi": {
    ...
    "app.subtitle": "Không gian tạo prompt",
    ...
    "settings.download_dir": "Thư mục tải ảnh ChatGPT",
    "settings.chromium_manager_url": "Chromium Profile Manager URL",
    "settings.chromium_profile_id": "Chromium profile ID",
    "settings.chromium_port": "Automation port (debug)",
    ...
    "status.chatgpt_image_running": "Đang gửi sang ChatGPT...",
    "status.chatgpt_image_waiting": "Đang chờ ChatGPT tạo ảnh...",
    "status.chatgpt_image_sent": "Đã gửi sang ChatGPT",
    ...
    "btn.open_chatgpt": "Tạo ảnh trên ChatGPT",
    "btn.close": "Đóng",
    "btn.retry": "Thử lại",
    ...
    "error.chatgpt_image": "Không tự tạo ảnh trên ChatGPT được.",
    ...
    "message.chatgpt_image_sent": "Đã upload {count} ảnh, nhập prompt và bấm gửi trên ChatGPT.",
    "message.chatgpt_image_downloaded": "Đã tạo và tải ảnh về: {path}",
    "message.chatgpt_image_request_downloaded": "Đã chờ request ảnh hoàn tất, xác nhận file ảnh và tải bằng request về: {path}",
  ...
  "en": {
    ...
    "settings.language.en": "English",
    "settings.api_key": "Secret API key",
    "settings.download_dir": "ChatGPT image download folder",
    "settings.chromium_manager_url": "Chromium Profile Manager URL",
    "settings.chromium_profile_id": "Chromium profile ID",
    "settings.chromium_port": "Automation port (debug)",
    ...
    "status.chatgpt_image_running": "Sending to ChatGPT...",
    "status.chatgpt_image_waiting": "Waiting for ChatGPT image...",
    "status.chatgpt_image_sent": "Sent to ChatGPT",
    ...
    "btn.open_chatgpt": "Generate in ChatGPT",
    "btn.close": "Close",
    "btn.retry": "Retry",
    ...
    "error.chatgpt_image": "Could not automate ChatGPT image generation.",
    ...
    "message.chatgpt_image_sent": "Uploaded {count} images, typed the prompt, and submitted it in ChatGPT.",
    "message.chatgpt_image_downloaded": "Generated and downloaded image to: {path}",
    "message.chatgpt_image_request_downloaded": "Waited for the image request, verified the image file, and downloaded by request to: {path}",
